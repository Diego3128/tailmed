      ...
      {emptyPatients ? (
        <div className="mt-30 pb-20">
          <h3 className="capitalize font-black text-3xl text-center">
            {translations.petList.emptyTitle.en}
          </h3>
          <p className="text-xl mt-5 text-center mb-10 text-indigo-700">
            {translations.petList.emptyDescription.en}
          </p>
        </div>
      ) : (
        <>
          <h3 className="capitalize font-black text-3xl text-center">
            {translations.petList.listTitle.en}
          </h3>
          <p className="text-xl mt-5 text-center mb-10 text-pretty">
            {translations.petList.listDescription.en}
          </p>
